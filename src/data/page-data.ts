export const contactBar = {
  contactItems: [
    {
      type: "email",
      label: "dembek@brooklyn.edu",
      icon: "/images/icon/mail-icon.svg",
      link: "mailto:dembek@brooklyn.edu",
    },
    {
      type: "website",
      label: "Brooklyn College Faculty",
      icon: "/images/icon/web-icon.svg",
      link: "https://www.brooklyn.cuny.edu/web/academics/faculty/faculty_profile.jsp?faculty=1482",
    },
  ],
  socialItems: [
    {
...
export const contactLinks = {
  socialLinks: [
    ...
    { title: "ResearchGate", href: "https://researchgate.net/profile/Ginny-Dembek" },
    {
      title: "Brooklyn College Profile",
      href: "https://www.brooklyn.cuny.edu/web/academics/faculty/faculty_profile.jsp?faculty=1482",
    },
  ],
  contactInfo: [
    { type: "email", label: "dembek@brooklyn.edu", link: "mailto:dembek@brooklyn.edu" },
    {
      type: "location",
