      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            ...
            <p className="mb-8">
              The first consultation is free. Share a brief description of your child or organization and what support you are seeking. Tutoring is in person in Brooklyn. Consulting for schools and organizations is available across NYC and surrounding areas, including virtual appointments.
            </p>
